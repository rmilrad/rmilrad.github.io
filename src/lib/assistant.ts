...
const KB: Entry[] = [
  {
    ...
    answer:
      "I'm Ryan — a platform product manager with **6+ years** at the intersection of data infrastructure, AI tooling, and platform engineering.\n\nMost recently at Coinbase I expanded, secured, and accelerated the Staking Platform: migrating billions onto new key-management infra, shipping LLM-powered developer tooling, and building real-time API dashboards.\n\nI think like an engineer and operate like a product leader.",
  },
  {
    id: "last-role",
  ...
  },
  {
    ...
    answer:
      "Where I've worked:\n- **Coinbase** — Product Manager · 2025–2026 · Staking Platform + PM AI\n- **Hemi** (built by Bloq) — Sr. PM / PM · 2023–2025 · L2 launch, bridge, DEX\n- **Bloq** — Product Manager · 2021–2023 · institutional staking infra\n- **Weight Watchers** — Data Scientist Intern · 2017 · NLP + data pipelines\n\nScroll down for the full breakdown of each.",
  },
  {
    id: "ai",
    keywords: ["ai", "llm", "mcp", "claude", "tooling", "automation", "agent", "model", "gen ai", "machine learning"],
    tool: "grep -r 'AI' experience/",
    answer:
  ...
  },
  {
    ...
    answer:
      "Happy to talk. You can reach me at **ryanmilrad34@gmail.com** or connect on **LinkedIn** (/in/ryan-milrad).\n\nThe contact section at the bottom of the page has direct links.",
  },
];
